...
/** @constructor */
function $c_Lscripts_TestLib$() {
  $c_O.call(this);
  this.navActive$1 = false;
  this.windowListener$1 = null
}
$c_Lscripts_TestLib$.prototype = new $h_O();
$c_Lscripts_TestLib$.prototype.constructor = $c_Lscripts_TestLib$;
/** @constructor */
function $h_Lscripts_TestLib$() {
  /*<skip>*/
}
$h_Lscripts_TestLib$.prototype = $c_Lscripts_TestLib$.prototype;
$c_Lscripts_TestLib$.prototype.init___ = (function() {
  $n_Lscripts_TestLib$ = this;
  this.navActive$1 = false;
  this.windowListener$1 = (function(e$2) {
    $m_Lscripts_TestLib$().addNavButtonListener__V();
    $m_Lscripts_TestLib$().addBodyListener__V()
  });
  return this
});
$c_Lscripts_TestLib$.prototype.toggleNav__V = (function() {
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Toggling nav\n");
  var navBar = (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("#main-nav");
  if ($uZ(navBar.hasClass("inactive"))) {
    navBar.removeClass("inactive");
    navBar.addClass("active");
    this.navActive$1 = true;
    (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body).toggleClass("no-scroll")
  } else if ($uZ(navBar.hasClass("active"))) {
...
$c_Lscripts_TestLib$.prototype.bodyScope__V = (function() {
  if (this.navActive$1) {
    this.toggleNav__V()
  }
});
$c_Lscripts_TestLib$.prototype.$$js$exported$meth$addNavButtonListener__O = (function() {
  this.addNavButtonListener__V()
});
$c_Lscripts_TestLib$.prototype.main__V = (function() {
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("main\n");
  $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().addEventListener("load", this.windowListener$1, false)
});
$c_Lscripts_TestLib$.prototype.$$js$exported$meth$addBodyListener__O = (function() {
  this.addBodyListener__V()
});
$c_Lscripts_TestLib$.prototype.addNavButtonListener__V = (function() {
  var nav_button = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("nav-button");
  nav_button.addEventListener("click", (function(e$2) {
    var this$2 = $m_s_Console$();
    var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
    this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Button clicked\n");
    e$2.preventDefault();
    $m_Lscripts_TestLib$().toggleNav__V()
  }), false)
});
$c_Lscripts_TestLib$.prototype.$$js$exported$meth$toggleNav__O = (function() {
  this.toggleNav__V()
});
$c_Lscripts_TestLib$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lscripts_TestLib$.prototype.addBodyListener__V = (function() {
  var body_box = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("content-box");
  body_box.addEventListener("click", (function(e$2) {
    e$2.preventDefault();
    $m_Lscripts_TestLib$().bodyScope__V()
  }), false)
});
$c_Lscripts_TestLib$.prototype.$$js$exported$meth$bodyScope__O = (function() {
  this.bodyScope__V()
});
$c_Lscripts_TestLib$.prototype.addNavButtonListener = (function() {
  return this.$$js$exported$meth$addNavButtonListener__O()
});
$c_Lscripts_TestLib$.prototype.addBodyListener = (function() {
  return this.$$js$exported$meth$addBodyListener__O()
});
$c_Lscripts_TestLib$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
$c_Lscripts_TestLib$.prototype.toggleNav = (function() {
  return this.$$js$exported$meth$toggleNav__O()
});
$c_Lscripts_TestLib$.prototype.bodyScope = (function() {
  return this.$$js$exported$meth$bodyScope__O()
});
var $d_Lscripts_TestLib$ = new $TypeData().initClass({
  Lscripts_TestLib$: 0
}, false, "scripts.TestLib$", {
  Lscripts_TestLib$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lscripts_TestLib$.prototype.$classData = $d_Lscripts_TestLib$;
var $n_Lscripts_TestLib$ = (void 0);
function $m_Lscripts_TestLib$() {
  if ((!$n_Lscripts_TestLib$)) {
    $n_Lscripts_TestLib$ = new $c_Lscripts_TestLib$().init___()
  };
  return $n_Lscripts_TestLib$
}
$e.scripts = ($e.scripts || {});
$e.scripts.TestLib = $m_Lscripts_TestLib$;
...
//# sourceMappingURL=personal_site-fastopt.js.map
